...
module.exports.getDecryptedAccessToken = () => {
    ...
    // set your original key phrese for encryption and decription to salt.
    const salt = 'your-salt-phrase';

    // encryption.
    // if you don't know encrypted value, you can confirm it to uncomment and execute sources of line 17 and 18.
    // (Encrypted value is displayed at your console as a log)
    // set value you want to encrypt and decript to planeText.
    //
